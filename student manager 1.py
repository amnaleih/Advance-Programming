...
root.configure(bg="#f1ef4e")

# --- Title ---
tk.Label(root, text="Student Manager", font=("Garamond", 20, "bold"), bg="#ffffff").pack(pady=20)

# --- Top Button Frame (Row 1) ---
button_frame_top = tk.Frame(root, bg="#5EC480")
...
view_frame = tk.Frame(root, bg="#5EC480")
view_frame.pack(pady=15)

tk.Label(view_frame, text="View Individual Student Record:", bg="#5EC480", font=("Arial", 10)).pack(side=tk.LEFT, padx=5)
